...
app = Flask(__name__)
model = joblib.load(r"D:\Projects\Resume Projects\15th, 16th  - Clustering,iq, RP, N\student mark price prediction\Student Mark Predictor Project Deployment\Student mark Predictor Deployment\student_mark_predictor.pkl")
