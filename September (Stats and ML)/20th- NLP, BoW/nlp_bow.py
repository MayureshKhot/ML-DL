...
# Create the empty list name as corpus becuase after cleanrdt the data corpus
...
# Creating the Bag of Words Model, also called as document matrix

from sklearn.feature_extraction.text import CountVectorizer
cv = CountVectorizer()
X_bow = cv.fit_transform(corpus).toarray()
# Here there is ambiguity issue, therefore we use Tfidf


#Tfidf = Term frequency * inverse document frequency
#here log calculations are there
